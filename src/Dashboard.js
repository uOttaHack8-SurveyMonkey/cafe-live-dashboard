...
import { surveyRecords } from "./data/surveyRecords";
...
export default function Dashboard() {
  ...
  const [todaySurveys, setTodaySurveys] = useState(41);
  useEffect(() => {
    const i = setInterval(() => {
      setTodaySurveys((p) => p + Math.floor(Math.random() * 2));
    }, 6000);
    ...
    <div style={styles.page}>
      <div style={styles.topBar}>
        <div style={styles.brandLeft}>
          <img src={monkeyLogo} alt="Chatter Monkey" style={styles.logo} />
          <div>
